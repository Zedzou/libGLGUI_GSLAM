...
Node::Node(int label):idx(label), 
                      instance_idx(0), 
                      mDebug(false),
                      time_stamp(0),
                      lastUpdatePropertySize(0),
                      mbNeedUpdateNodeFeature(false),
                      mIdxCounter(0) 
{
...
void Node::Update(const int label, const int index, const Eigen::Vector3f& pos, const Eigen::Vector3f& normal, const std::array<unsigned char, 3>& color) 
{
