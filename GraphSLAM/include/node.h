...
namespace GSLAM
{
    class Node
    {
        ...
        public:
            ...
            void UpdatePrediction( const std::map<std::string, float>&pd, const std::map<std::string, std::pair<size_t, size_t>> &sizeAndEdge, bool fusion );
