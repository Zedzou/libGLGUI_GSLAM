...
namespace inseg_lib 
{
    ...
    {
        public:    
            InSegReconstruction(std::shared_ptr<inseg_lib::SegmentsInterface> segments, InSegConfig& config, MainConfig& main_config, MapConfig& map_config, const SegmentationConfig& segmentation_config);
        ...
        private:
            ...
            void CalculateLabelSizeList(const cv::Mat* label_map, const int label_num, std::vector<int16_t>* label_size_list);
