...
namespace GLUtils
{
    ...
    template<class T>
    static Eigen::Matrix<T,4,4> Perspective(float fx,
                                            float fy, 
                                            float cx, 
                                            float cy, 
                                            int width, 
    ...
    {
        public:
            static std::vector<GLUtils::Vertex> skybox;
            static std::vector<GLUtils::Vertex> cube;
            static std::vector<GLUtils::Vertex> plane;
            static std::vector<GLUtils::Vertex> quad;
    };
