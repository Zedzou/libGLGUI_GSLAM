...
namespace GLRenderer
{
    ...
    // GL_UI
    class GL_ContentBase : public GL_base
    {
        public:
            // 构造析构
            explicit GL_ContentBase (const std::string &name, int width, int height, bool visible=true);
            virtual ~GL_ContentBase ();
        ...
        protected:
            ...
            std::map<std::string, GLUtils::Shader*> glShaders;
            std::map<std::string, GLUtils::Model_base*> glObjests;
            ...
            void RenderText(GLuint VAO, GLuint VBO, GLUtils::Shader *shader, std::string text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color);
